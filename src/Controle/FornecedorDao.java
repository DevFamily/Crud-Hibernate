...
/**
    ...
    */
    public int salvarFornecedorDAO(Fornecedor pModelFornecedor){
        try {
            this.conectar();
            return this.insertSQL("INSERT INTO tb_fornecedor ("
                    + "fd_nome,"
                    + "fd_morada,"
                    + "fd_contacto,"
                    + "fd_email"
    ...
    */
    public Fornecedor retornarFornecedorDAO(int pIdfornecedor){
        ...
        try {
            ...
            this.executarSQL("SELECT "
                    ...
                    + "fd_contacto,"
                    + "fd_email"
                 + " FROM tb_fornecedor WHERE fd_idfornecedor = '"+pIdfornecedor+"';");
    ...
    * recupera uma lista de Fornecedor
        * return ArrayList
    */
    public ArrayList<Fornecedor> retornarListaFornecedorDAO(){
    ...
    */
    public boolean atualizarFornecedorDAO(Fornecedor pModelFornecedor){
        try {
            this.conectar();
            return this.executarUpdateDeleteSQL("UPDATE tb_fornecedor SET "
                    + "fd_nome = '" + pModelFornecedor.getNome() + "',"
                    + "fd_morada = '" + pModelFornecedor.getMorada() + "',"
                    + "fd_contacto = '" + pModelFornecedor.getContacto() + "',"
                    + "fd_email = '" + pModelFornecedor.getEmail() + "'"
                + " WHERE fd_idfornecedor = '" + pModelFornecedor.getIdfornecedor() + "'"
                + ";"
            );
        }catch(Exception e){
            e.printStackTrace();
    ...
    public boolean excluirFornecedorDAO(int pIdfornecedor){
        try {
            ...
            return this.executarUpdateDeleteSQL(
                "DELETE FROM tb_fornecedor WHERE fd_idfornecedor = '" + pIdfornecedor + "'"
